...
imgBackground = cv2.imread('C:\\Users\\Dell\\PycharmProjects\\Python\\resources\\background.png')

# ----------importing mode images in the list-----------------#
...
print("loading encode file.... might take few seconds")
...
while True:
    ...
    # -------------combining the camera and the modes by specifying the size of the frames----------
